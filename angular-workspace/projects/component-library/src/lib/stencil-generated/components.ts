...
import { Components } from '@koomzocomponents/dist/components';




export declare interface AppDraggable extends Components.AppDraggable {}

@ProxyCmp({
  defineCustomElementFn: undefined,
  inputs: ['dropData', 'droppable']
})
@Component({
...
export declare interface AppDroppable extends Components.AppDroppable {
  /**
   *  
   */
  elementDropped: EventEmitter<CustomEvent<any>>;
...
export class AppDroppable {
  ...
  constructor(c: ChangeDetectorRef, r: ElementRef, protected z: NgZone) {
    c.detach();
    this.el = r.nativeElement;
proxyOutputs(this, this.el, ['elementDropped']);
  }
}
...
import type { OverlayEventDetail as IActionSheetOverlayEventDetail } from '@koomzocomponents/dist/components';
...
import type { OverlayEventDetail as IAlertOverlayEventDetail } from '@koomzocomponents/dist/components';
...
import type { CheckboxChangeEventDetail as ICheckboxCheckboxChangeEventDetail } from '@koomzocomponents/dist/components';
...
import type { ScrollBaseDetail as IContentScrollBaseDetail } from '@koomzocomponents/dist/components';
import type { ScrollDetail as IContentScrollDetail } from '@koomzocomponents/dist/components';
...
import type { DatetimeChangeEventDetail as IDatetimeDatetimeChangeEventDetail } from '@koomzocomponents/dist/components';
...
import type { InputChangeEventDetail as IInputInputChangeEventDetail } from '@koomzocomponents/dist/components';
...
import type { OverlayEventDetail as ILoadingOverlayEventDetail } from '@koomzocomponents/dist/components';
...
import type { OverlayEventDetail as IModalOverlayEventDetail } from '@koomzocomponents/dist/components';
...
import type { OverlayEventDetail as IPickerOverlayEventDetail } from '@koomzocomponents/dist/components';
...
import type { OverlayEventDetail as IPopoverOverlayEventDetail } from '@koomzocomponents/dist/components';
...
import type { RadioGroupChangeEventDetail as IRadioGroupRadioGroupChangeEventDetail } from '@koomzocomponents/dist/components';
...
import type { RangeChangeEventDetail as IRangeRangeChangeEventDetail } from '@koomzocomponents/dist/components';
...
import type { RefresherEventDetail as IRefresherRefresherEventDetail } from '@koomzocomponents/dist/components';
...
import type { ItemReorderEventDetail as IReorderGroupItemReorderEventDetail } from '@koomzocomponents/dist/components';
...
import type { RouterEventDetail as IRouterRouterEventDetail } from '@koomzocomponents/dist/components';
...
import type { SearchbarChangeEventDetail as ISearchbarSearchbarChangeEventDetail } from '@koomzocomponents/dist/components';
...
import type { SegmentChangeEventDetail as ISegmentSegmentChangeEventDetail } from '@koomzocomponents/dist/components';
...
import type { SelectChangeEventDetail as ISelectSelectChangeEventDetail } from '@koomzocomponents/dist/components';
...
import type { TextareaChangeEventDetail as ITextareaTextareaChangeEventDetail } from '@koomzocomponents/dist/components';
...
import type { OverlayEventDetail as IToastOverlayEventDetail } from '@koomzocomponents/dist/components';
...
import type { ToggleChangeEventDetail as IToggleToggleChangeEventDetail } from '@koomzocomponents/dist/components';
...
export declare interface KzDraggable extends Components.KzDraggable {}

@ProxyCmp({
  defineCustomElementFn: undefined,
  inputs: ['dropData', 'droppableList']
})
@Component({
  selector: 'kz-draggable',
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: '<ng-content></ng-content>',
  inputs: ['dropData', 'droppableList']
})
...
export declare interface KzDroppable extends Components.KzDroppable {
  /**
   *  
   */
  elementDropped: EventEmitter<CustomEvent<any>>;
...
export declare interface StencilAsyncContent extends Components.StencilAsyncContent {}
...
@Component({
  selector: 'stencil-async-content',
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: '<ng-content></ng-content>',
  inputs: ['documentLocation']
})
export class StencilAsyncContent {
  protected el: HTMLElement;
  constructor(c: ChangeDetectorRef, r: ElementRef, protected z: NgZone) {
    c.detach();
    this.el = r.nativeElement;
...
export declare interface StencilRoute extends Components.StencilRoute {}

@ProxyCmp({
  defineCustomElementFn: undefined,
  inputs: ['component', 'componentProps', 'componentUpdated', 'exact', 'group', 'history', 'historyType', 'location', 'match', 'routeRender', 'routeViewsUpdated', 'scrollTopOffset', 'url']
})
@Component({
  selector: 'stencil-route',
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: '<ng-content></ng-content>',
  inputs: ['component', 'componentProps', 'componentUpdated', 'exact', 'group', 'history', 'historyType', 'location', 'match', 'routeRender', 'routeViewsUpdated', 'scrollTopOffset', 'url']
})
...
export declare interface StencilRouteLink extends Components.StencilRouteLink {}

@ProxyCmp({
  defineCustomElementFn: undefined,
  inputs: ['activeClass', 'anchorClass', 'anchorId', 'anchorRole', 'anchorTabIndex', 'anchorTitle', 'ariaHaspopup', 'ariaLabel', 'ariaPosinset', 'ariaSetsize', 'custom', 'exact', 'history', 'location', 'root', 'strict', 'url', 'urlMatch']
})
@Component({
  selector: 'stencil-route-link',
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: '<ng-content></ng-content>',
  inputs: ['activeClass', 'anchorClass', 'anchorId', 'anchorRole', 'anchorTabIndex', 'anchorTitle', 'ariaHaspopup', 'ariaLabel', 'ariaPosinset', 'ariaSetsize', 'custom', 'exact', 'history', 'location', 'root', 'strict', 'url', 'urlMatch']
})
export class StencilRouteLink {
  protected el: HTMLElement;
  constructor(c: ChangeDetectorRef, r: ElementRef, protected z: NgZone) {
    c.detach();
    this.el = r.nativeElement;
...
export declare interface StencilRouteSwitch extends Components.StencilRouteSwitch {}

@ProxyCmp({
  defineCustomElementFn: undefined,
  inputs: ['group', 'location', 'routeViewsUpdated', 'scrollTopOffset']
})
@Component({
  selector: 'stencil-route-switch',
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: '<ng-content></ng-content>',
  inputs: ['group', 'location', 'routeViewsUpdated', 'scrollTopOffset']
})
...
export declare interface StencilRouteTitle extends Components.StencilRouteTitle {}

@ProxyCmp({
  defineCustomElementFn: undefined,
  inputs: ['pageTitle', 'titleSuffix']
})
@Component({
  selector: 'stencil-route-title',
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: '<ng-content></ng-content>',
  inputs: ['pageTitle', 'titleSuffix']
})
export class StencilRouteTitle {
  protected el: HTMLElement;
  constructor(c: ChangeDetectorRef, r: ElementRef, protected z: NgZone) {
    c.detach();
    this.el = r.nativeElement;
...
export declare interface StencilRouter extends Components.StencilRouter {}

@ProxyCmp({
  defineCustomElementFn: undefined,
  inputs: ['historyType', 'root', 'scrollTopOffset', 'titleSuffix']
})
@Component({
  selector: 'stencil-router',
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: '<ng-content></ng-content>',
  inputs: ['historyType', 'root', 'scrollTopOffset', 'titleSuffix']
})
...
export declare interface StencilRouterPrompt extends Components.StencilRouterPrompt {}

@ProxyCmp({
  defineCustomElementFn: undefined,
  inputs: ['history', 'message', 'when']
})
@Component({
  selector: 'stencil-router-prompt',
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: '<ng-content></ng-content>',
  inputs: ['history', 'message', 'when']
})
...
export declare interface StencilRouterRedirect extends Components.StencilRouterRedirect {}

@ProxyCmp({
  defineCustomElementFn: undefined,
  inputs: ['history', 'root', 'url']
})
@Component({
  selector: 'stencil-router-redirect',
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: '<ng-content></ng-content>',
  inputs: ['history', 'root', 'url']
})
